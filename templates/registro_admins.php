...
if(!$link){
	...
	$SQL='INSERT INTO usuarios (USUARIO_TYPE,USUARIO_CORREO,USUARIO_NOMBRE,USUARIO_PATERNO,USUARIO_MATERNO,USUARIO_CONTRASENIA,FECHA_REGISTRO) values (2,"'.$correo.'","'.$nombre.'","'.$paterno.'","'.$materno.'","'.$contrasena.'","'.$fecha.'");';
